...
export class ProductsService {
  ...
  async findOne(id: Types.ObjectId): Promise<ProductEntity> {
    return this.ProductModel.findById(id)
  }

  async update(id: Types.ObjectId, updateProductDto: UpdateProductDto): Promise<ProductEntity> {
    await this.ProductModel.findByIdAndUpdate(id, updateProductDto)

    return this.findOne(id)
  }

  async remove(id: Types.ObjectId): Promise<ProductEntity> {
